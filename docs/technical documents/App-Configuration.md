...
**File:** `server/src/Divvy.Api/Controllers/AppConfigController.cs`
...
**File:** `server/src/Divvy.Api/Models/AppConfigEntry.cs`
...
**File:** `server/src/Divvy.Api/Services/AppConfigService.cs`
