...
Batanai uses **Cloudflare Pages** to host and serve the MkDocs-generated technical documentation site. The wiki is the single source of truth for all developer, architectural, and feature documentation for the platform.
...
- **Custom domain** â€” the wiki can be served under a subdomain (e.g., `docs.batanai.elroitec.com`) managed through Cloudflare DNS.
