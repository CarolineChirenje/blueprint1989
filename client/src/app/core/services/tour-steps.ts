...
export const memberTourSteps: TourStepDef[] = [
  {
    ...
    text: `
      ...
      <strong>rotating savings groups</strong> (Mukando) with friends, family, or flatmates.</p>
  ...
  },
  {
    ...
    text: 'This is your home base. You\'ll see a personalised greeting and today\'s date here.',
  ...
  },
  {
    ...
    text: `
      <p>That's everything to get started. Your next step:</p>
      <p><strong>Create a group</strong> or <strong>join one</strong> and start sharing expenses!</p>
    `,
    classes: 'shepherd-welcome',
  },
];
