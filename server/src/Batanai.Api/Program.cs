...
builder.Services.AddDbContext<ApplicationDbContext>(options =>
{
    ...
    {
        npgsqlOptions.MigrationsAssembly("Batanai.Api");
...
builder.Services.AddSingleton<IFido2>(_ =>
{
    ...
    return new Fido2(new Fido2Configuration
    {
        ...
        ServerName   = webAuthnConfig["RelyingPartyName"] ?? "Batanai",
...
if (builder.Environment.IsDevelopment())
{
    ...
    {
        c.SwaggerDoc("v1", new() { Title = "Batanai API", Version = "v1" });
    });
}
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Batanai API");
    });
}
else
{
