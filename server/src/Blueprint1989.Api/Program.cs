using Blueprint1989.Api.Configuration;
...
builder.Services.AddDbContext<ApplicationDbContext>(options =>
{
    ...
    {
        npgsqlOptions.MigrationsAssembly("Blueprint1989.Api");
...
builder.Services.AddSingleton<IFido2>(_ =>
{
    ...
    return new Fido2(new Fido2Configuration
    {
        ...
        ServerName   = webAuthnConfig["RelyingPartyName"] ?? "Blueprint1989",
...
if (builder.Environment.IsDevelopment())
{
    ...
    {
        c.SwaggerDoc("v1", new() { Title = "Blueprint1989 API", Version = "v1" });
    });
}
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Blueprint1989 API");
    });
}
else
{
